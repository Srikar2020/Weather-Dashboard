...
// Names of cities that have been searched
...
// Extract info from the OpenWeatherMap API and display it to the page

    function extractInfo() {

// This if statement will assign cityName to value that user has searched

        if (($("#search").val() !== null) && ($("#search").val() !== "")) {
            var cityName = $("#search").val().trim();
        } else {

// The else statement part will assign cityName to city that user has clicked in search history
